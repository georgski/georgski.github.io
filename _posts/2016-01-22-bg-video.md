...
<video src="{{ "/assets/posts/1/video.webm" | absolute_url }}" controls preload="auto" autoplay="autoplay" loop="loop" style="width: 300px; margin: 40px auto; display: block;">
Sorry, your browser doesn't support embedded webm videos, 
but don't worry, you can <a href="{{ "/assets/posts/1/video.webm" | absolute_url }}">download it</a>
...
![]({{ "/assets/posts/1/fig_1.png" | absolute_url }})
